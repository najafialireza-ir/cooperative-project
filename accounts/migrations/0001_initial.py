    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('1', 'user'), ('2', 'driver'), ('3', 'admin')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destanition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='d_travel', to='accounts.city')),
                ('driver_car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='driver_car', to='accounts.drivercar')),
                ('startcity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s_travel', to='accounts.city')),
            ],
        ),
        migrations.CreateModel(
            name='Wallet',
